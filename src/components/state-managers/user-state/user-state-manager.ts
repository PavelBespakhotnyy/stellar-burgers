...
const initialUserState: TUserStateManager = {
  isAuthChecked: false,
...
export const userApi = createAsyncThunk('userState/getUserApi', getUserApi);
export const updateUser = createAsyncThunk(
  'userState/updateUserApi',
  async (
...
const userStateManager = createSlice({
  name: 'userState',
...
export const {
  ...
  getLoginUserRequest,
  getLoginUserError
} = userStateManager.selectors;
export const { authChecked } = userStateManager.actions;
export default userStateManager.reducer;
